...
@pytest.mark.parametrize("name, red, green, blue, expected", [
    ("White", 255, 255, 255, {"type": "rgb", "name": "White", "red": 255, "green": 255, "blue": 255}),
    ("Black", 0, 0, 0, {"type": "rgb", "name": "Black", "red": 0, "green": 0, "blue": 0}),
])
...
@pytest.mark.parametrize("name, hue, saturation, lightness, expected", [
    ("Red", 0, 100, 50, {"type": "hsl", "name": "Red", "hue": 0, "saturation": 100, "lightness": 50}),
    ("Green", 120, 100, 50, {"type": "hsl", "name": "Green", "hue": 120, "saturation": 100, "lightness": 50}),
])
...
@pytest.mark.parametrize("name, red, green, blue, expected", [
    ("Bright Red", 10000, 0, 0, {"type": "brgb", "name": "Bright Red", "red": 10000, "green": 0, "blue": 0}),
    ("Dark Green", 0, 10000, 0, {"type": "brgb", "name": "Dark Green", "red": 0, "green": 10000, "blue": 0}),
])
